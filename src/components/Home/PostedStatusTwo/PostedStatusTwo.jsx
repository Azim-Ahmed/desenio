...
import environment1 from "../../../assets/images/environment-1.png";
import environment2 from "../../../assets/images/environment-2.png";
        ...
        <div>
          <div className="flex gap-2 mb-4">
            ...
            <div className="my-auto">
              <h6 className="text-[#000000] text-[16px] leading-6">Shinobu Oshino</h6>
...
export default PostedStatusTwo;
